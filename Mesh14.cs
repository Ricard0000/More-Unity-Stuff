...
//        vertices = new Vector3[84];
  //      triangles = new int[417];
    //    uvs = new Vector2[84];
        ...
        for (int i = 0; i < N; i++)
        {
            uvs[i] = new Vector2(0f, i / (float)(N - 1));
        }
        int nextUvVert = N;

        for (int i = 0; i < N; i++)
        {
            uvs[nextUvVert + i] = new Vector2(0.25f / 1.25f, i / (float)(N - 1));
        }
        ...
        for (int i = 0; i < N; i++)
        {
            uvs[nextUvVert + i] = new Vector2(0.5f / 1.25f, i / (float)(N - 1));
        }
        nextUvVert = N + nextUvVert;

        for (int i = 0; i < N; i++)
        {
            uvs[nextUvVert + i] = new Vector2(0.75f / 1.25f, i / (float)(N - 1));
        }
        ...
        for (int i = 0; i < N; i++)
        {
            uvs[nextUvVert + i] = new Vector2(1.0f / 1.25f, i / (float)(N - 1));
        }
        nextUvVert = N + nextUvVert;

        for (int i = 0; i < N; i++)
        {
            uvs[nextUvVert + i] = new Vector2(1f, i / (float)(N - 1));
        }
