...
public class ArchBrickWall1 : MonoBehaviour
{
    ...
    public static GameObject MakeDiscreteProceduralGrid(float Pos1, float Pos2, float Pos3, int N, int N1, Material mat, bool collider)
    {
        ...
        vertices[0] = new Vector3(-0.875f, 0.003662168f - 0.03125f, -0.4270834f);
        uvs[0] = new Vector2(vertices[0].y, vertices[0].z);

        vertices[1] = new Vector3(-0.875f, 0.003662168f - 0.03125f, -0.9270833f);
        uvs[1] = new Vector2(vertices[1].y, vertices[1].z);

        vertices[2] = new Vector3(-0.875f + 0.03125f, 0.003662168f - 0.03125f, -0.9270833f);
        uvs[2] = new Vector2(vertices[2].y, vertices[2].z);

        vertices[3] = new Vector3(-0.875f + 0.03125f, 0.003662168f - 0.03125f, -0.4270834f);
        uvs[3] = new Vector2(vertices[3].y, vertices[3].z);


        vertices[4] = new Vector3(-0.875f + 0.03125f, 0.003662168f - 0.03125f, -0.9270833f);
        uvs[4] = new Vector2(vertices[4].x, vertices[4].z);

        vertices[5] = new Vector3(-0.875f + 0.03125f, 0.003662168f - 0.03125f, -0.4270834f);
        uvs[5] = new Vector2(vertices[5].x, vertices[5].z);

        vertices[6] = new Vector3(-0.875f + 0.03125f, 0.003662168f - 0.03125f - 0.25f, -0.9270833f);
        uvs[6] = new Vector2(vertices[6].x, vertices[6].z);

        vertices[7] = new Vector3(-0.875f + 0.03125f, 0.003662168f - 0.03125f - 0.25f, -0.4270834f);
