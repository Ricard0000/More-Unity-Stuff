...
public class Mesh43 : MonoBehaviour
{
    ...
    public static GameObject MakeDiscreteProceduralGrid(float Pos1, float Pos2, float Pos3, int N, int N1, Material mat, bool collider)
    {
        ...
        {
            vertices[i] = vertices[i] * meshScale + new Vector3(-0.574f + 1.138f, 0.992f, -3.933f);
        }
        ...
        {
            uvs[i] = new Vector2(vertices[i].x - 1.138f, vertices[i].y);
        }
