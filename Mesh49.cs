...
public class Mesh49 : MonoBehaviour
{
    ...
    public static GameObject MakeDiscreteProceduralGrid(Material mat, bool collider)
    {
        ...
        Vector3 Pos1 = new Vector3(0f, 0f, -.08f);
        Vector3 Pos2 = new Vector3(0f, 0f, -.08f - 0.16f);
        Vector3 Pos3 = new Vector3(0f, 0f, 0.08f);
        Vector3 Pos4 = new Vector3(0f, 0f, .08f + 0.16f);

        Vector3 Pos5 = new Vector3(0f, 0.26875f + 0.0f, 0f);
        Vector3 Pos6 = new Vector3(0f, 0.26875f + 0.25f + 0.0f, 0f);
        Vector3 Pos7 = new Vector3(0f, 0.26875f + 2f * 0.25f + 0.0f, 0f);
        Vector3 Pos8 = new Vector3(0f, 0.26875f + 3f * 0.25f + 0.0f, 0f);



        float scaleHorizontal = 0.025f/1.5f;
        float scaleVertical = 1.5f;

        float scaleHorizontal2 = 1.1f;
        float scaleVertical2 = 1.5f * 0.02f/1.5f;
        ...
        for (int i = 0; i < 32; i++)
        {
            vertices[i] = vertices[i] + new Vector3(2.378f, 0.199f + 0.4f, -3.134f);
        }

        for (int i = 0; i < 8; i++)
        {
            triangles[0 + 6 * i] = 1 + 4 * i;
            triangles[1 + 6 * i] = 2 + 4 * i;
            triangles[2 + 6 * i] = 0 + 4 * i;
            triangles[3 + 6 * i] = 3 + 4 * i;
            triangles[4 + 6 * i] = 2 + 4 * i;
